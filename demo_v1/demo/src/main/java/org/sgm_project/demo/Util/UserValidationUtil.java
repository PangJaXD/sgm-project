...
public class UserValidationUtil {
    ...
    // 1. ภาษาอังกฤษหรือตัวเลข, ความยาวตั้งแต่ 8 ตัวอักษร และไม่เกิน 20 ตัวอักษร, ไม่มีเว้นวรรค, ไม่เป็นค่าว่าง
    private static final Pattern USERNAME_PATTERN = Pattern.compile("^[a-zA-Z0-9]{8,20}$");

    // 2. ตัวอักษรภาษาอังกฤษหรือตัวเลข รวมอักขระพิเศษ [ !#_. ], ความยาวตั้งแต่ 8 ตัวอักษร และไม่เกิน 16 ตัวอักษร, ไม่มีเว้นวรรค, ไม่เป็นค่าว่าง
    ...
    public static void validateUsername(String username) {
        ...
        if (username.length() < 8 || username.length() > 20) {
            throw new IllegalArgumentException("ชื่อผู้ใช้งานต้องมีความยาวตั้งแต่ 8 ตัวอักษร และไม่เกิน 20 ตัวอักษร");
        }
        if (!USERNAME_PATTERN.matcher(username).matches()) {
            throw new IllegalArgumentException("ชื่อผู้ใช้งานต้องเป็นตัวอักษรภาษาอังกฤษหรือตัวเลขเท่านั้น");
        }
    }
    ...
    public static void validatePassword(String password) {
        ...
        if (!PASSWORD_PATTERN.matcher(password).matches()) {
            throw new IllegalArgumentException("รหัสผ่านต้องเป็นตัวอักษรภาษาอังกฤษ ตัวเลข หรืออักขระพิเศษ [ !#_. ] เท่านั้น");
        }
    }
}
